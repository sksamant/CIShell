...
public class WorkflowGUI implements WorkflowTreeItem {
	 ...
	 * 
	 * @param model
	 *            the DataModel this DataModelGUIItem is using
	 * @param parent
	 *            the parent DataModelGUIItem of this DataModelGUIItem
	 * @param brandPluginID
	 */
	...
	/**
	 * Returns the parent DataModelGUIItem of this DataModelGUIItem, or null if
	 * this is the root item.
	 * 
	 * @return the parent DataModelGUIItem of this DataModelGUIItem, or null if
	 *         this is the root item
	 */
	...
	/**
	 * Removes the given DataModelGUIItem from the collection of children of
	 * this DataModelGUIItem.
	 * 
	 * @param item
	 *            the child of this DataModelGUIItem to remove
	 */
	...
	private static Image getDefaultImage() {
		ImageDescriptor imageDescriptor = AbstractUIPlugin
				.imageDescriptorFromPlugin(null, DEFAULT_IMAGE_LOCATION);
		return imageDescriptor.createImage();
	}
	...
	public void setWorkflow(WorkflowItem workflowItem) {
